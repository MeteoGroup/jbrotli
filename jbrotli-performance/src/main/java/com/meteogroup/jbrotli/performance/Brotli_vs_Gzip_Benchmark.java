...
package com.meteogroup.jbrotli.performance;

import com.meteogroup.jbrotli.Brotli;
import com.meteogroup.jbrotli.BrotliCompressor;
...
public class Brotli_vs_Gzip_Benchmark {
  ...
  public void brotli_compression_with_BrotliStreamCompressor_using_byte_array() {
    out = brotliStreamCompressor.compress(cpHtmlData, 0, cpHtmlData.length, true);
